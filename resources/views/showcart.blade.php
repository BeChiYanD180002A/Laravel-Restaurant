                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/cafe_logo.jpg" align="WDS cafe" width="80" height="80">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#about">About</a></li><li class="scroll-to-section"><a href="#menu">Menu</a></li>
